...
<div class="navbar navbar-inverse" role="navigation">
    <div class="navbar-header">
        <div class="logo"><h1>Admin page | Dashboard</h1></div>
...
<div class="template-page-wrapper">
    <div class="navbar-collapse collapse templatemo-sidebar">
        <ul class="templatemo-sidebar-menu">
            ...
            <li><a href="/pages/admin/statistic.jsp"><i class="fa fa-cubes"></i><span class="badge pull-right"></span>Статистика</a></li>
            <li><a href="/pages/admin/tables.jsp"><i class="fa fa-users"></i><span class="badge pull-right"></span>Таблицы</a></li>
            <li><a href="/pages/admin/profile.jsp"><i class="fa fa-cog"></i>Профиль</a></li>
            <li><a href="javascript:;" data-toggle="modal" data-target="#confirmModal"><i class="fa fa-sign-out"></i>Выйти</a></li>
        </ul>
    </div><!--/.navbar-collapse -->
...
<script src="/resources/adminPage/js/bootstrap.min.js"></script>
<script src="/resources/adminPage/js/Chart.min.js"></script>
<script src="/resources/adminPage/js/admin_script.js"></script>
